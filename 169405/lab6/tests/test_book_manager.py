...
class TestBookManager(unittest.TestCase):
    ...
    def test_remove_book(self):
        ...
        # Test removing unavailable book
        self.manager.add_book("B002", "Python Programming", "John Smith")
        self.manager.books["B002"]['available'] = False
        result = self.manager.remove_book("B001")
        self.assertFalse(result)
        self.assertIn("B002", self.manager.books)  # Book should still exist
